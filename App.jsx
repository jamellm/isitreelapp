...
const T = {
  en: {
    ...
    urlNote: "Works with Facebook and TikTok. For YouTube, X, and Instagram, download the video and use the Upload File tab.",
  ...
  es: {
    ...
    urlNote: "Funciona con Facebook y TikTok. Para YouTube, X e Instagram, descarga el video y usa la pestaña Subir Archivo.",
  ...
  pt: {
    ...
    urlNote: "Funciona com Facebook e TikTok. Para YouTube, X e Instagram, baixe o vídeo e use a aba Enviar Arquivo.",
    urlAnalyze: "ESCANEAR ESTA URL →",
  ...
  fr: {
    ...
    urlNote: "Fonctionne avec Facebook et TikTok. Pour YouTube, X et Instagram, téléchargez la vidéo et utilisez l'onglet Télécharger Fichier.",
