...
const T = {
  ...
  pt: {
    ...
    "Cole uma URL do Facebook Reels para um veredicto instantâneo — sem downloads. Tem um vídeo de outra plataforma? Baixe-o e envie diretamente.",
  ...
  fr: {
    ...
    "Collez une URL Facebook Reels pour un verdict instantané — sans téléchargement. Vous avez une vidéo d'une autre plateforme? Téléchargez-la et uploadez-la directement.",
